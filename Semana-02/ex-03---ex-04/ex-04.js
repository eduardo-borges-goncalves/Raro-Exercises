...
function desafio1asRosasNaoFalam2() {
    return __awaiter(this, void 0, void 0, function () {
        var geraIntervaloAleatório, queixoMeAsRosas, masQueBobagem, asRosasNaoFalam, simplesmenteAsRosasExalam, oPerfumeQueRoubamDeTi;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    geraIntervaloAleatório = function () { return Math.floor(Math.random() * 3 * 1000); };

...
function escreveArquivo(texto) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    (0, fs_1.writeFile)(ARQUIVO_DE_FILA, texto, "utf-8", function (err) {
...
function escreveNaFila(texto) {
    return __awaiter(this, void 0, void 0, function () {
        var textoAtual, novoTexto;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, leArquivo()];
                case 1:
                    textoAtual = _a.sent();
                    novoTexto = textoAtual ? "".concat(textoAtual, "\n").concat(texto) : texto;
                    return [4 /*yield*/, escreveArquivo(novoTexto)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function consumirDaFila() {
    return __awaiter(this, void 0, void 0, function () {
        var textoAtual, _a, linhaConsumida, linhas;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, escreveArquivo(linhas.join('\n'))];
                case 2:
                    _b.sent();
                    return [2 /*return*/, linhaConsumida];
            }
        });
    });
}
